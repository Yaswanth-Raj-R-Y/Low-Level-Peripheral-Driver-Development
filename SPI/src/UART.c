...
void UART_init(USART_TypeDef* UART, UART_Typedef* uartConfig)
{
    ...
    {
        RCC->APB2ENR |= 0x00000010;     // USART1 clock enable
    ...
    {
        RCC->APB2ENR |= 0x00000020;     // USART6 clock enable
    ...
    // Enable USART by setting UE bit
    UART->CR1 |= 0x00002000;
    ...
    // Set stop bit configuration (default: 1 stop bit)
    UART->CR2 |= 0x00003000;
